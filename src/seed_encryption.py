...
# Deliberately expensive enough to slow down brute-force attemps
...
def derive_key(passphrase: str, salt: bytes) -> bytes:
    ...
    maxmem = 132 * SCRYPT_N * SCRYPT_R    # explicity raise the memory ceiling.
...
def encrypt_entropy(entropy_bytes: bytes, passphrase: str) -> str:
    """
    Encrypts raw seed entropy under a passphrase-derived key.
    """
...
try:
    ...
    raise ValueError(
        "Decryption failed: wrong passphrase, or the stored blob"
